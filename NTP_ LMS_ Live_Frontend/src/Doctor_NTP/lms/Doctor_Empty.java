...
//Phone Number
        driver.findElement(By.name("mobile_no")).sendKeys("");
                driver.findElement(By.name("alternate_contact_no")).sendKeys("");
//CNIC
        driver.findElement(By.name("cnic")).sendKeys("");
//Province
...
//Work Experience
       ...
       Select c = new Select(driver.findElement(By.name("work_experience")));
        ...
        Thread.sleep(2000);
//PMDC Card Number
        driver.findElement(By.name("pmdc_registration_number")).sendKeys("");
        Thread.sleep(2000);
